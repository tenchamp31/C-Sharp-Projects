...
namespace CarInsurance.Controllers
{
    public class InsureeController : Controller
    {
        ...
        public static void Insurance(Insuree insuree)
        {
            insuree.Quote = 50; //base of 50

            int yearsofage = 0;
            yearsofage = DateTime.Now.Year - insuree.DateofBirth.Year; //calculating the exact date
            ...
            else if (yearsofage >= 19 && yearsofage <25) //between the ages of 19-25 add 50
            {
                insuree.Quote += 50;
            }
